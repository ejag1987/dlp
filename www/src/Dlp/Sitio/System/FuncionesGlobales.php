...
class FuncionesGlobales
{
     ...
     * @return bool
     */
    public static function buscarValorArreglo($arreglo, $valor, $indice)
    {
        $item = null;
        $existe = false;

        foreach($arreglo as $struct) {
    ...
    public static function buscaIndiceObjeto($objeto, $valor, $indice)
    {
        $item = null;
        $existe = false;
        $index = 0;
