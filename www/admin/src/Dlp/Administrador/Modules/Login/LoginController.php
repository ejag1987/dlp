...
namespace Dlp\Administrador\Modules\Login;

use Dlp\Administrador\Modules\Login\Models\LoginModel;
use Dlp\Administrador\Modules\Login\Views\LoginView;
...
class LoginController extends BaseController
{
    ...
    private function comprobarUsuario()
    {
        ...
        $this->session->setString('usuario', $usuario->login);
        $this->session->setString('nombre', $usuario->nombre.' '.$usuario->apellido);
