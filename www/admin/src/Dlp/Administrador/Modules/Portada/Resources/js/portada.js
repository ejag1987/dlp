...
function activarGuardarSlide() {
    ...
    boton.on('click', function() {
        ...
        var id_slide, databloque, datos, result, error;

        id_slide    = $(this).data('id');
        databloque = $(this).parents('.botones-slide').first().data('bloque');
        error      = $('#error-'+databloque+'-'+id_slide);
        datos      = camposValidar(databloque+'-'+id_slide);
        ...
        result.datos.id_slide    = id_slide;
...
function activarGuardar() {
    ...
    boton.on('click', function() {
        ...
        var id_caluga, databloque, datos, result, error;

        id_caluga    = $(this).data('id');
        databloque = $(this).parents('.botones-slide').first().data('bloque');
        error      = $('#error-'+databloque+'-'+id_caluga);
        datos      = camposValidar(databloque+'-'+id_caluga);
        result     = $.parseJSON(datos);
        ...
        result.datos.id_caluga    = id_caluga;
        result.datos.databloque = databloque;
